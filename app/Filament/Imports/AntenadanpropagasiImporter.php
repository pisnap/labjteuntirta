...
class AntenadanpropagasiImporter extends Importer
{
    protected static ?string $model = Antenadanpropagasi::class;
    ...
    public function resolveRecord(): ?Antenadanpropagasi
    {
        return Antenadanpropagasi::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Antenadanpropagasi();
    }
