...
class DasarsistemkendaliImporter extends Importer
{
    protected static ?string $model = Dasarsistemkendali::class;
    ...
    public function resolveRecord(): ?Dasarsistemkendali
    {
        return Dasarsistemkendali::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Dasarsistemkendali();
    }
