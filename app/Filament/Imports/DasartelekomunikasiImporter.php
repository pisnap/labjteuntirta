...
class DasartelekomunikasiImporter extends Importer
{
    protected static ?string $model = Dasartelekomunikasi::class;
    ...
    public function resolveRecord(): ?Dasartelekomunikasi
    {
        return Dasartelekomunikasi::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Dasartelekomunikasi();
    }
