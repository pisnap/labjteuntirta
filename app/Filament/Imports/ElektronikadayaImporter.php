...
class ElektronikadayaImporter extends Importer
{
    protected static ?string $model = Elektronikadaya::class;
    ...
    public function resolveRecord(): ?Elektronikadaya
    {
        return Elektronikadaya::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Elektronikadaya();
    }
