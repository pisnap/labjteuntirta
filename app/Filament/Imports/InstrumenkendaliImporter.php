...
class InstrumenkendaliImporter extends Importer
{
    protected static ?string $model = Instrumenkendali::class;
    ...
    public function resolveRecord(): ?Instrumenkendali
    {
        return Instrumenkendali::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Instrumenkendali();
    }
