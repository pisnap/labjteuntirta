...
class KomputasinumerikImporter extends Importer
{
    protected static ?string $model = Komputasinumerik::class;
    ...
    public function resolveRecord(): ?Komputasinumerik
    {
        return Komputasinumerik::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Komputasinumerik();
    }
