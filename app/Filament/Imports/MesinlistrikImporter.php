...
class MesinlistrikImporter extends Importer
{
    protected static ?string $model = Mesinlistrik::class;
    ...
    public function resolveRecord(): ?Mesinlistrik
    {
        return Mesinlistrik::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Mesinlistrik();
    }
