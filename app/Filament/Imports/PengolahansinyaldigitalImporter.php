...
class PengolahansinyaldigitalImporter extends Importer
{
    ...
    public function resolveRecord(): ?Pengolahansinyaldigital
    {
        return Pengolahansinyaldigital::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Pengolahansinyaldigital();
    }
