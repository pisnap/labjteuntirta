...
class PengukuranlistrikImporter extends Importer
{
    protected static ?string $model = Pengukuranlistrik::class;
    ...
    public function resolveRecord(): ?Pengukuranlistrik
    {
        return Pengukuranlistrik::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Pengukuranlistrik();
    }
