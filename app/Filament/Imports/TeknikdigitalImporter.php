...
class TeknikdigitalImporter extends Importer
{
    protected static ?string $model = Teknikdigital::class;
    ...
    public function resolveRecord(): ?Teknikdigital
    {
        return Teknikdigital::firstOrNew([
            // Update existing records, matching them by `$this->data['column_name']`
            'nim' => $this->data['nim'],
        ]);

        return new Teknikdigital();
    }
