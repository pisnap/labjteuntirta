...
use App\Filament\Imports\PlagiarismeikImporter;
use App\Models\Plagiarismeik as PlagiarismeikModel;

class Plagiarismeik extends Page
{
    // protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.pages.plagiarismeik';

    protected static ?string $navigationLabel = 'Plagiarisme Instrumen kendali';

    protected static ?string $title = 'Daftar Plagiarisme';

    protected static ?string $slug = 'transparansi-plagiarisme-ik';
        ...
        return [
            ButtonAction::make('deleteAll')
                ...
                ->action(function () {
                    ...
                    PlagiarismeikModel::query()->delete();
            ...
            ImportAction::make()
                ...
                ->importer(PlagiarismeikImporter::class)
                ->visible(fn() => Auth::user()->role == 'Admin'),
        ];
    }
}
