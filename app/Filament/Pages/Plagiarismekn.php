...
use App\Filament\Imports\PlagiarismeknImporter;
use App\Models\Plagiarismekn as PlagiarismeknModel;

class Plagiarismekn extends Page
{
    // protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.pages.plagiarismekn';

    protected static ?string $navigationLabel = 'Plagiarisme Komputasi Numerik';

    protected static ?string $title = 'Daftar Plagiarisme';

    protected static ?string $slug = 'transparansi-plagiarisme-kn';
        ...
        return [
            ButtonAction::make('deleteAll')
                ...
                ->action(function () {
                    ...
                    PlagiarismeknModel::query()->delete();
            ...
            ImportAction::make()
                ...
                ->importer(PlagiarismeknImporter::class)
                ->visible(fn() => Auth::user()->role == 'Admin'),
        ];
    }
}
