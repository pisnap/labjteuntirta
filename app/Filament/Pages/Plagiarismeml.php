...
use App\Filament\Imports\PlagiarismemlImporter;
use App\Models\Plagiarismeml as PlagiarismemlModel;

class Plagiarismeml extends Page
{
    // protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.pages.plagiarismeml';

    protected static ?string $navigationLabel = 'Plagiarisme Mesin Listrik';

    protected static ?string $title = 'Daftar Plagiarisme';

    protected static ?string $slug = 'transparansi-plagiarisme-ml';
        ...
        return [
            ButtonAction::make('deleteAll')
                ...
                ->action(function () {
                    ...
                    PlagiarismemlModel::query()->delete();
            ...
            ImportAction::make()
                ...
                ->importer(PlagiarismemlImporter::class)
                ->visible(fn() => Auth::user()->role == 'Admin'),
        ];
    }
}
