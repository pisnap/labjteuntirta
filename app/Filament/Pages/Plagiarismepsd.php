...
use App\Filament\Imports\PlagiarismepsdImporter;
use App\Models\Plagiarismepsd as PlagiarismepsdModel;

class Plagiarismepsd extends Page
{
    // protected static ?string $navigationIcon = 'heroicon-o-document-text';

    protected static string $view = 'filament.pages.plagiarismepsd';

    protected static ?string $navigationLabel = 'Plagiarisme Pengolahan Sinyal Digital';

    protected static ?string $title = 'Daftar Plagiarisme';

    protected static ?string $slug = 'transparansi-plagiarisme-psd';
        ...
        return [
            ButtonAction::make('deleteAll')
                ...
                ->action(function () {
                    ...
                    PlagiarismepsdModel::query()->delete();
            ...
            ImportAction::make()
                ...
                ->importer(PlagiarismepsdImporter::class)
                ->visible(fn() => Auth::user()->role == 'Admin'),
        ];
    }
}
